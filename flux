...
$$ |  $$\ $$ |      $$ |  $$ |$$ |  $$ |$$ |  $$ | $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |  $$ |
\$$$$$$  |$$ |      $$$$$$$  |\$$$$$$$ |$$$$$$$  | \$$$$  |$$ |  $$ |\$$$$$$  |$$$$$$$  |
 \______/ \__|      $$  ____/  \____$$ |$$  ____/   \____/ \__|  \__| \______/ \_______/ 
                    $$ |      $$\   $$ |$$ |                                             
                    $$ |      \$$$$$$  |$$ |                                             
                    \__|       \______/ \__|                                             
]]--
...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	function Tabs:Tab(text,ico)
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			Value.Text = tostring(start and math.floor((start / max) * (max - min) + min) or 0.001)
			...
			function SliderFunc:Change(tochange)
				...
				Value.Text = tostring(tochange and math.floor((tochange / max) * (max - min) + min) or 0.001)
		...
		function ContainerContent:ChangeLabel1()
			local Label = Instance.new("TextButton")
			local LabelCorner = Instance.new("UICorner")
			local Title = Instance.new("TextLabel")
        ...
        function ContainerContent:ColorLabel(text)
			local Label = Instance.new("TextButton")
			local LabelCorner = Instance.new("UICorner")
			local Title = Instance.new("TextLabel")
			...
			Label.Font = Enum.Font.SourceSans
			Label.Text = ""
			Label.TextColor3 = Color3.fromRGB(124, 248, 221)
			Label.TextSize = 14.000
			...
			Title.Font = Enum.Font.Gotham
			Title.Text = text
			Title.TextColor3 = Color3.fromRGB(124, 248, 221)
			Title.TextSize = 15.000
			Title.TextTransparency = 0.300
			Title.TextXAlignment = Enum.TextXAlignment.Left
